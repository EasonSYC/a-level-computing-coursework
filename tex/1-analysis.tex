...
\begin{figure}[htp]
    ...
    \includegraphics[width=0.6\linewidth]{kevi-past-page.png}
...
\begin{figure}[htp]
    ...
    \includegraphics[width=0.6\linewidth]{srev-past-page.png}
...
\begin{figure}[htp]
    ...
    \includegraphics[width=0.6\linewidth]{kevi-map.png}
    \caption{Past earthquake page map of KEVI.}
    \label{fig:kevi-map}
\end{figure}

In particular for KEVI, there is also a tree structure on a panel displaying the details of the observed intensities by hierarchy structure, consisting of prefectures, skipping regions, then districts, then the exact observation stations, as shown in \ref{fig:kevi-intensity-tree}.

\begin{figure}[htp]
    \centering

    \includegraphics[width=0.6\linewidth]{kevi-intensity-tree.png}
...
\begin{figure}[htp]
    ...
    \includegraphics[width=0.6\linewidth]{kevi-real-time-page.png}
    \caption{Real-time page of KEVI.}
    \label{fig:kevi-real-time}
\end{figure}

\begin{figure}[htp]
    \centering

    \includegraphics[width=0.6\linewidth]{kevi-tsunami.png}
    \caption{Tsunami page of KEVI.}
    \label{fig:kevi-tsunami}
\end{figure}

\begin{figure}[htp]
    \centering

    \includegraphics[width=0.6\linewidth]{srev-real-time-page.png}
    \caption{Real-time page of SREV.}
    \label{fig:srev-real-time}
\end{figure}

\begin{figure}[htp]
    \centering

    \includegraphics[width=0.6\linewidth]{srev-tsunami-page.png}
    \caption{Tsunami page of SREV.}
    \label{fig:srev-tsunami}
\end{figure}
