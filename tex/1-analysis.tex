...
In addition to these colours, for tsunami informational advisory, the colour \Colour{80FFFF} is used, in accordance with the colour used for no release of river flooding warning, and for endings of tsunamis warnings, the colour \Colour{F2F2FF} is used, in accordance with the minimal level (the extremely light grey) in Figure \ref{fig:jma-colour-scheme-tsunami}.
