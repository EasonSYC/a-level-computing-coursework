...
\ToDo{Include analysis on GUI as well}
...
\begin{enumerate}
    ...
    \item \textbf{GUI Design} -- Corresponding to \textbf{Part 3, 4 and 5}, in Table \ref{tab:requirements-part-three}
\end{enumerate}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{c|l|p{15em}|l}
        ...
        2a(ii)           & Display current time at the corner        & Time displayed and refreshing every second          & IT   \\
...
\begin{table}[!ht]
    ...
    \begin{tabular}{c|p{0.42\linewidth}|p{0.3\linewidth}|l}
        ...
        2a(ix)*          & Display real-time shake data at a user-defined point                      & Display the name of the point with acceleration and intensity & IT      \\
    \end{tabular}
