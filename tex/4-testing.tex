...
\begin{table}[htp]
    ...
    \begin{tabular}{c|l|l}
        ...
        1b(vi)      & Press WebSocket button twice            & WebSocket connected and then disconnected
    \end{tabular}
...
\begin{table}[htp]
    ...
    \begin{tabular}{c|l|l}
        ...
        2(xii)      & Another earthquake chosen          & Application behaves with 5 to 11 as described      \\
...
\begin{table}[htp]
    ...
    \begin{tabular}{c|l|l}
        ...
        3a(vi)      & Change stations settings to K-NET only     & Less observation station displayed       \\
        3a(vii)     & Relaunch application                       & Settings Persist                         \\
        3a(viii)    & Change stations settings to all            & More observation station displayed       \\
...
\begin{table}[htp]
    ...
    \begin{tabular}{c|l|l}
        ...
        3b(vi)      & (Feed Second Mock EEW, assumed hypocentre) & EEW is displayed on sidebar            \\
        3b(vii)     & (None)                                     & Hypocentre marked (alternative symbol) \\
        ...
        3b(xi)      & (Feed Updated First Mock EEW)              & EEW Information Updated (in 2 to 4)    \\
...
\begin{table}[htp]
    ...
    \begin{tabular}{c|l|l}
        ...
        4(iii)      & Press buttons when Incorrect API Key      & Application does not crash         \\
        4(iv)       & (None)                                    & Authorisation automatically resets \\
        4(v)        & Press buttons when OAuth 2 invalid        & Application does not crash         \\
        4(vi)       & (None)                                    & Authorisation automatically resets \\
        4(vii)      & Unstable Internet Connection              & Application does not crash         \\
        4(viii)     & Clicking buttons at rapid pace            & Application does not crash         \\
        4(ix)       & Loading earthquakes where details unknown & 'Unknown' text displayed
    \end{tabular}
