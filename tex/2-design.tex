...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.5\linewidth]{class-diagram-ui-view-model-settings.pdf}
...
\paragraph{Models for Past Earthquake Page}

\paragraph{Models for Real-Time Page}
