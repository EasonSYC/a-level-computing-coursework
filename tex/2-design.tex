...
It would be painful to implement \Code{INotifyPropertyChanged} for every single model/view model, since we would need to implement a backing (private) field, and a public property whose set property raises the \Code{PropertyChanged} event.
