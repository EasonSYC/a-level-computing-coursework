...
\begin{table}[!ht]
    ...
    \begin{tabular}{|c|c|}
        ...
        \hline
        \lstinline{contract.list}           &                    \\
        \lstinline{eew.get.forecast}        &                    \\
        \lstinline{gd.earthquake}           &                    \\
        \lstinline{gd.eew}                  &                    \\
        \lstinline{parameter.earthquake}    &                    \\
        \lstinline{parameter.realtime}      &                    \\
        \lstinline{parameter.tsunami}       &                    \\
        \lstinline{socket.start}            &                    \\
        \lstinline{socket.list}             &                    \\
        \lstinline{socket.close}            &                    \\
        \lstinline{telegram.data}           &                    \\
        \lstinline{telegram.get.earthquake} &                    \\
        \lstinline{telegram.list}           &                    \\
        \hline
    \end{tabular}
