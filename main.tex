...
\[
    f_V(h) = \begin{cases}
        1.8h + 0.8, & h \in [0, 0.1], \\
        -4.4h + 1.42, & h \in [0.1, 0.175], \\
        6.8h - 0.54, & h \in [0.175, 0.2], \\
...
A flowchart of how data will flow is included in Figure \ref{fig:convert-kmoni}, and how those variables are related is shown in Figure \ref{fig:variable-relation}.

\begin{figure}[!ht]
    \centering
    \includegraphics[width = 0.5\linewidth]{hierarchy_chart.png}
    \caption{Flow of data in NIED data sources}
    \label{fig:convert-kmoni}
\end{figure}
