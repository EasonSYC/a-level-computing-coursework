...
From this part onwards, in the API sample results, all \Code{nextToken}, \Code{nextPooling} and \Code{nextPoolingInterval} will be removed, but if they are included in the result, it would be explicitly stated.
...
\subparagraph{Early Earthquake Warnings}
...
The data achieved by the previous two data sources will certainly use objects (classes, records) to transfer between different components of the program.
